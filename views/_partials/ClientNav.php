...
// Define navigation links for client
$navLinks = [
...
<nav class="admin-navbar <?= $darkMode ? 'dark-mode' : '' ?>">
    <div class="container">
...
<style>
/* Client Navbar Styles with Dark Mode Support */
.admin-navbar {
...
.admin-navbar.dark-mode .admin-nav-link.active {
...
.admin-navbar.dark-mode .user-icon {
    color: #f39c12;
}
...
.admin-navbar.dark-mode .logout-btn:hover {
...
.admin-navbar.dark-mode .admin-mobile-menu {
...
.admin-navbar.dark-mode .admin-mobile-link:hover,
.admin-navbar.dark-mode .admin-mobile-link.active {
    background-color: #f39c12;
}
...
.admin-navbar.dark-mode .admin-mobile-user {
    border-top-color: rgba(255, 255, 255, 0.05);
}
...
.admin-navbar.dark-mode .admin-mobile-user .border-b {
